...
- ✨ **AI 智能自然语言解析**：集成 DeepSeek/OpenAI，支持自然语言识别（如“明天下午三点开会”），一键自动填充任务要素。
- 🛡️ **BYOK 银行级硬件加密**：AI 密钥本地存储，采用 Web Crypto API 的 AES-256-GCM 算法与用户自设 PIN 码深度加密，防 XSS 窃取。
...
- v3.5.0 - 引入 AI 大语言模型接口与自然语言智能建任务，BYOK安全重构
